...
- recorded Leni with Tobii TX300 and R-Net Caps. Raw data has already been combined with EEG triggers:
see merge_eeg_with_triggers_from_csv.r.
- electrode position information is converted to catesian coordinates and plotted for visual inspection


```{r load EEG, echo=FALSE}
...
loads data and selects according task data
...
flat, noisy, and low cor channels
...
```{r preprocessed data inspection}
